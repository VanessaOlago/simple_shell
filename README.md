...
By Brian Murithi, and Vanessa Olago

A simple command-line interpreter developed as an end of trimester project.
...
| ---------------------------------------------------https--------- | ------------------------------------------------------------ |
| `char *user_input(void);`                                    | [user_input.c](https://github.com/Njirugity/simple_shell/blob/master/user_input.c) |
| `char **tokens(char *buffer);`                               | [tokens.c](https://github.com/Njirugity/simple_shell/blob/master/tokens.c) |
| `int main(void);`                                            | [shell_main.c](https://github.com/Njirugity/simple_shell/blob/master/shell_main.c) |
| `char *_getenv(char *var_name);`                             | [shell_getenv.c](https://github.com/Njirugity/simple_shell/blob/master/shell_getenv.c) |
| `int run(char **args);`                                      | [run.c](https://github.com/Njirugity/simple_shell/blob/master/run.c) |
| `void *_realloc(void *ptr, size_t old_size, size_t new_size);` | [100-realloc.c](https://github.com/Njirugity/simple_shell/blob/master/100-realloc.c) |
| `int _execute(char **args);`<br />`int _exit(char **argv)`   | [execute.c](https://github.com/Njirugity/simple_shell/blob/master/execute.c) |
| ** String functions **<br />`int _strlen(char *s);`<br />`char *_strchr(char *s, char c);`<br />`char *_strcat(char *dest, char *src);`<br />`int _strcmp(char *s1, char *s2);`<br />`char *str_concat(char *s1, char *s2);` | <br />[_strlen.c](https://github.com/Njirugity/simple_shell/blob/master/_strlen.c)<br />[_strchr.c](https://github.com/Njirugity/simple_shell/blob/master/_strchr.c)<br />[_strcat.c](https://github.com/Njirugity/simple_shell/blob/master/_strcat.c)<br />[_strcmp.c](https://github.com/Njirugity/simple_shell/blob/master/3-strcmp.c)<br />[2-str_concat.c](https://github.com/Njirugity/simple_shell/blob/master/2-str_concat.c) |
| `man_1_simple_shell`                                         | [man_1_simple_shell](https://github.com/Njirugity/simple_shell/blob/master/man_1_simple_shell) |
